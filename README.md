...
*(replace `#` with the link to your Notion case study page)*
...
1. Import [`workflow/next-best-cs-action-engine.json`](workflow/next-best-cs-action-engine.json) into your own n8n instance (**Workflows → Import from File**).
